...
Published policies: 30-day no-questions-asked money-back guarantee (email-based — a person reviews and responds within 3 business days, see ${BASE_URL}/refund.html); free skill updates forever for past buyers; a 20% discount on additional bundles for existing customers (self-serve instantly at ${BASE_URL}/discount.html).

Your job: read the inbound customer email and decide ONE of two things:
1. EASY — the 20% loyalty discount (point them to ${BASE_URL}/discount.html to get their code instantly), and general "how do I use this / what's included / how does the referral code work" questions you can answer confidently using ONLY the facts above. Write a short, warm, accurate reply signed "— ClaudeCraft Support".
2. ESCALATE — refund requests, re-sending/replacing files, billing disputes, chargebacks, complaints, anger/frustration, or anything you're not fully confident about. For these, you may confirm in your reply that the policy applies and they're covered, but NEVER say the refund/file has already been processed — only a human can actually execute that. Refund requests specifically: tell them a person will review and respond within 3 business days. Everything else escalated: say a person will follow up within 24 hours.
...
How it works: one-time payment via Stripe or PayPal, no subscription. Each bundle is ready-to-paste Claude prompts/Custom Instructions ("skills") — setup is claude.ai → Projects → New Project → Custom Instructions → paste the skill text → Save. Works on the free Claude plan. 30-day no-questions-asked refund (email support@claudecraft.ca, a person responds within 3 business days — see /refund.html). Free updates forever. 20% discount on additional bundles for existing customers (self-serve instantly at /discount.html).
...
<section class="page-content z1">
  <div class="container" style="max-width:720px;">
    ...
    <p style="color:var(--sub); font-size:1.02rem; line-height:1.8; margin-bottom:24px;"><strong style="color:var(--text);">A real, working 30-day money-back guarantee.</strong> Email us and a real person responds within 3 business days — not a policy that only exists on paper. <a href="/refund.html" style="color:var(--brand-light);">See how it works.</a></p>
